---
title: "[컴퓨터 보안] 컴퓨터 보안과 대칭키/공개키 암호"
categories: [컴퓨터보안]
tags: [보안]
---
...
- **공개키**: 누구나 공개키를 이용하여 <u>암호화</u> 가능
- **개인키**: 오직 자신만 개인키를 이용하여 <u>복호화</u> 가능
...
- 공개키 암호 알고리즘은 일방향 성질을 갖는 수학적으로 어려운 문제들에 기반을 둔다.
  - 소인수분해 문제: RSA 알고리즘
  - 이산대수 문제: ElGamal, DSA, KCDSA
  - 타원곡선 이산대수 문제: ECDSA
...
- 키 생성(수신자)
  ...
  - 개인키 (d,p,q) 준비
- **암호화(송신자)**
  - n보다 작은 숫자인 평문 M을 수신자의 **공개키**를 이용하여 암호문 C 계산
- **복호화(수신자)**
  - 암호문 C를 수신자의 **개인키**를 이용하여 복호화
